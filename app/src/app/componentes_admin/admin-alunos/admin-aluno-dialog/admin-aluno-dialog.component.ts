...
@Component({
  ...
  export class AdminAlunoDialogComponent {
    ...
    constructor(
      ...
      @Inject(MAT_DIALOG_DATA) public dialogData: { mode: string; aluno: Aluno },
      ...
      this.form = this.formBuilder.group({
        ...
        nome: [this.dialogData.aluno.nome, [Validators.required, Validators.maxLength(255), Validators.minLength(3), Validators.pattern("^[a-zA-Z ]*$")]],
        ...
        rg: [this.dialogData.aluno.rg, [Validators.required, Validators.maxLength(8),Validators.pattern("^[0-9]*$"), Validators.minLength(4)]],
        telefone: [this.dialogData.aluno.telefone, [Validators.required, Validators.maxLength(11),Validators.pattern("^[0-9]*$"), Validators.minLength(8)]],
